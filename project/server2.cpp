//Example code: A simple server side code, which echos back the received http_response.
...
{  
    ...
    {  
        ...
        {  
            ...
            //send new connection greeting http_response
            // char welcome_message[] = "Welcome message from Server\n"; 
        ...
        {  
            ...
            {  
                ...
                //incoming http_response 
                if ((valread = recv( sd , http_request, 100000, 0)) == 0) // ! Neu khong nhan duoc gi nua o client  
                {  
